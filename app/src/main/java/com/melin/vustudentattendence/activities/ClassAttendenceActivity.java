...
import com.melin.vustudentattendence.rowAdapter.ClassAttendenceRowAdapter;
...
public class ClassAttendenceActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toolbar toolbar=(Toolbar)findViewById(R.id.activity_class_attendence_toolbar);
        setSupportActionBar(toolbar);
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        getSupportActionBar().setDisplayShowHomeEnabled(true);
        getSupportActionBar().setTitle("Attendence Center");
