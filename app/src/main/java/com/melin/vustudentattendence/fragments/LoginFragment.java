package com.melin.vustudentattendence.fragments;
...
import com.melin.vustudentattendence.activities.InstituteDashboardActivity;
import com.melin.vustudentattendence.activities.LecturerDashboardActivity;
                        ...
                        public void onComplete(@NonNull Task<QuerySnapshot> task) {
                            if (task.isSuccessful()) {
                                ...
                                for (QueryDocumentSnapshot document : task.getResult()) {
                                    ...
                                    if(data.get("role").toString().equals("lecturer") && uid.equals(document.getId().toString())){
